...
const UINT AV_SET_AUTOSIZE	= 23; // wParam  = one of the AUTO_SIZE constants., lParam = pointer to SIZE having maximum sizings. Makes some controls perform autosize behaviour.
const UINT AV_GET_AUTOSIZE  = 24; // return one of the AUTO_SIZE constants. if lParam != NULL, lParam = pointer to SIZE receiving maximum sizings. Makes some controls perform autosize behaviour.

// auto size constants
const INT AUTOSIZE_NONE					= 0x00;
const INT AUTOSIZE_CONTROL_TO_CONTENT	= 0x01;
const INT AUTOSIZE_CONTENT_TO_CONTROL	= 0x02;
