...
#define WM_UPDATED_SPLITTERPOS WM_USER +356
...
public:
   ...
   void UpdateSplitterLayout()
   {
	  ...
	  ::InvalidateRect(m_wndTop, NULL, FALSE);
	  ::InvalidateRect(m_wndBottom, NULL, FALSE);

	  ::SendMessage(GetParent(), WM_UPDATED_SPLITTERPOS, 0L, (LPARAM)this);
   }
...
template< class T, bool t_bVertical, class TBase, class TWinTraits > HCURSOR CSplitterBarImpl< T, t_bVertical, TBase, TWinTraits>::s_hCursor = NULL;
