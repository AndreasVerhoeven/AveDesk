...
//#include "stdafx.h"
#include "suckdll.h"
#include "SuckAnimDLL/resource.h"
...
HRESULT CSuckyAnimation::InitMesh()
{
	...
	hRes = D3DXLoadMeshFromXResource(HINST_THISCOMPONENT, "RC_DATA", MAKEINTRESOURCEA(IDR_RC_DATA1),D3DXMESH_VB_MANAGED, directDevice, &adj, &mat, &eff,  &numMaterials, &mesh);
